...
def main() -> None:
    ...
    try:
        if args.command == "init":
            ...
            result = {"daily": reports.close_day(args.date, args.note), "weekly": reports.weekly_report(args.date), "monthly": reports.monthly_report(args.date)}
        else:
